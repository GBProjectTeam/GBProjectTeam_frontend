...
export const RegistrationPage = () => {
    ...
    const formRegistration = () => (
        ...
        >
            ...
            <FormControl variant='filled' fullWidth sx={{ bgcolor: '#e8f1fe' }} required>
                <InputLabel htmlFor='filled-adornment-confirm-password'>Подтвердить пароль</InputLabel>
                <FilledInput
    ...
    return (
        <Stack justifyContent='space-evenly' component={Paper} height='80%' width='30%'>
            <Typography
                variant='h4'
                sx={{
                    textAlign: 'center',
